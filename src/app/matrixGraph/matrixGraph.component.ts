...
export class GraphComponent {
  ...
  public graph = {
        data: [
            { x: ['mudel1', 'mudel2', 'mudel3', 'mudel4', 'mudel5'], y: [2, 6, 3, 2, 4], text: ["Struktuur", 'Maksevõime', 'Rentaablus', 'Efektiivsus', 'Laen'],  name: 'Prognoos', type: 'scatter', mode: 'lines+points+text', marker: {color: 'rgb(98, 0, 255)'} },
            { x: ['mudel1','mudel2', 'mudel3', 'mudel4', 'mudel5'], y: [this.numbriloome(7), 5, 3, 4, 5], text: ["Struktuur", 'Maksevõime', 'Rentaablus', 'Efektiivsus', 'Laen'], name: 'Hetkeseis', type: 'bar', marker: {color: 'rgb(170, 255, 0)'} },
        ],
